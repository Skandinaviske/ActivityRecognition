...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("所以呢/ActivityRecogition");
    ...
    public void init(){
        ...
        //cv.put(NotesDB.CURRENTAC,"AAAA");
        //cv.put(NotesDB.ETIME,"SSSS");
        //cv.put(NotesDB.STIME,"JUE");
        //dbWriter = notesDB.getWritableDatabase();
        //dbWriter.insert(NotesDB.TABLE_NAME,null,cv);
        //dbWriter = notesDB.getReadableDatabase();
        //NotesDB.addDB();
        Log.d("进行到这一步了","Saaaaaaaaaaaa");
        //dbReader = notesDB.getReadableDatabase();
        //Cursor cursor = dbReader.query(NotesDB.TABLE_NAME,null,null,null,null,null,null);
        //if (cursor.moveToFirst()) {
        //    String content = cursor.getString(cursor.getColumnIndex(NotesDB.ETIME));
        //    Log.d("BBBBBBBBBB", content);}
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        Log.d("Whatisit",PendingIntent.FLAG_UPDATE_CURRENT+"");

        ActivityRecognitionClient activityRecognitionClient = ActivityRecognition.getClient(this);
        Task task = activityRecognitionClient.requestActivityUpdates(1000L, pendingIntent);
        //ActivityRecognition.ActivityRecognitionApi.requestActivityUpdates( mApiClient, 1000L, pendingIntent );
    }
